...
import { ReferResolutionEnvelope } from "../../core/contracts/referOrchestrator";
import { appendProcessEvent } from "../../telemetry/processEvents";
import { createConfiguredReferPromptModel } from "./referModelProvider";
import { createReferChatEvent } from "../../core/orchestration/referProcessEvents";
import { runReferResolutionLoop } from "../../core/orchestration/referResolutionLoop";
