...
- sync_runtime: `npm --prefix refer-zo-bootstrap run tandem:sync-runtime -- --instance telechurch --preset all --check`
...
- heartbeat: `npm run hive:registry:heartbeat -- --id telechurch --status ratifying --activity recent_activity --evidence "deployment pack ratification passed"`
